...
class Scratch3Interfaz {
    ...
    entradaEstado (args, util) {
        ...
        switch(args.ENTRADA_ESTADO) {
            case 'alto': case 1:  v =  i.analogValues[args.ENTRADAS_PARAM - 1] > i.analogThreshold[args.ENTRADAS_PARAM - 1] ; break;
            case 'bajo': case 0:  v =  i.analogValues[args.ENTRADAS_PARAM - 1] <= i.analogThreshold[args.ENTRADAS_PARAM - 1] ; break;
        }
        return v;
    }
    ...
    servoPosicion (args, util) {
        if(args.SERVOS_PARAM > MAX_SALIDAS) return;
